...
Figure 4 f, Figure 5 a, c Supplemental Figure 4 a, d, and Supplemental Figure 5 b, c

```{r}

#| label: Fig 4 f, Fig 5 a, c, Supp Fig 4 a, d, Supp Fig 5 b, c


# Define genes of interest
basal_list <- data.frame(gene = c("TNFSF12", "IL6R", "IL4R", "IL6", "TNFRSF12A", "THBS1", "IL4", "EPS8L1", "PLAUR"))
