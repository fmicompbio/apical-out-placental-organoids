...
This folder contains three quarto documents required to generate the figures for "A model of apical-out human first trimester trophoblast organoids to study regeneration after syncytial damage" on bioRxiv
...
This script will generate the following plots and tables for the bioRxiv submission: - Fig 2 b, d; - Supp Fig 1 d; - Supp Dat for Fig 2 b
